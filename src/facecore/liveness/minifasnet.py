"""MiniFASNet architectures for Silent-Face anti-spoofing.

Vendored verbatim from minivision-ai/Silent-Face-Anti-Spoofing (Apache-2.0) so
the pretrained `.pth` weights load with matching layer names. Do not edit the
layer structure — it must mirror the checkpoint exactly.
"""
